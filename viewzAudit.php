...
<?php
	...
	if(isset($zPeriodQuery)) {
		$zPeriodSQL = "AND questions.zPeriod = $zPeriodQuery";
	} else {
		$zperiodSQL = '';
	}
	...
	$sql = "
		...
		questions.questionProblemType,
		questions.questionSubtype,
		questions.questionContent,
		questions.questionAnswer,
		questions.questionDifficulty, 
		questions.zPeriod as zPeriod, 
		questions.zQuestionNumber as zQuestionNumber, 
		auditRank.auditRank
		FROM questions JOIN auditRank 
		WHERE questions.zPeriod = auditRank.zPeriod 
		AND questions.zQuestionNumber = auditRank.zQuestionNumber
		$zPeriodSQL 
		ORDER BY zPeriod, zQuestionNumber;
	";
...
?>
	...
	<div id="section-zCode">
		<div class="container">
			...
			<?php 			
				for ($i = 1; $i <= 8; $i++) {
					echo "<div class='four columns'><div class='box-zPeriod'><a href='viewzAudit.php?zPeriod=$i' title='Period $i'><span class='label'>Period</span> <span class='number'>$i</span></a></div></div>";
				}
			?>
				...
				<div class="question">
					...
					<div class="eight columns alpha">
						<div class="wrap-textarea-left">
							...
							<textarea class="selectAll" rows="10" cols="40"><?php echo $zOutput->zQuestionCode($qContent, $qType, $qSubtype, $zQuestionNumber, true); ?></textarea>
					...
					<div class="eight columns omega">
						<div class="wrap-textarea-right">
							...
							<textarea class="selectAll" rows="10" cols="40"><?php echo $zOutput->zAuditQuestionCode($zQuestionNumber, $auditRank); ?></textarea>
